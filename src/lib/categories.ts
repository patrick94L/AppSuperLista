...
const CATEGORY_KEYWORDS: Record<Category, string[]> = {
  'Lácteos': ['leche', 'yogurt', 'yoghurt', 'queso', 'mantequilla', 'manjar'],
  'Limpieza': ['cloro', 'detergente', 'paño', 'desinfectante', 'petalos', 'pétalos', 'lavaloza', 'lavavajilla', 'esponja', 'bolsa basura', 'bolsa de basura', 'limpiador', 'lejia', 'lejía'],
  ...
  'Frutas y verduras': ['papa', 'papas', 'cilantro', 'choclo', 'kiwi', 'zapallo', 'platano', 'plátano', 'tomate', 'acelga', 'cebolla', 'palta', 'limon', 'limón', 'manzana', 'naranja', 'lechuga', 'zanahoria', 'pepino', 'apio', 'pimenton', 'pimentón'],
  'Abarrotes': ['mayo', 'mayonesa', 'cereal', 'fajitas', 'atun', 'atún', 'salsa de tomate', 'aceite', 'pan', 'arroz', 'fideos', 'azucar', 'azúcar', 'sal', 'harina', 'galletas', 'colacion', 'colación', 'conserva', 'cafe', 'café'],
